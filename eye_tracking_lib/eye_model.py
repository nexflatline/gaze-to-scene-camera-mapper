...
class EyeModel3D:
    """Approximate spherical eye model for polynomial gaze features.

    eye_radius_px is the assumed pupil travel radius in eye-camera pixels
    (default 100). It only scales the feature polynomial; the ridge mapping
    still fits scene coordinates. Change this if the pupil is much larger or
    smaller in the frame than ~100 px from center to extreme gaze.
    """
